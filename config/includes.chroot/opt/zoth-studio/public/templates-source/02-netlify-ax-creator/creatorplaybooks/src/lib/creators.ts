...
import { CREATOR_MEDIA } from './mediaManifest';

export const CATEGORIES = [
  { id: 'netlify-shippers', label: 'Netlify AI Shippers', emoji: '🚀', description: 'High-volume builders shipping with Netlify and AI tools.' },
  { id: 'indie-hackers', label: 'Indie Hackers', emoji: '🛠️', description: 'Solo builders sharing their journey and products in public.' },
  { id: 'big-players', label: 'Big Players', emoji: '📡', description: 'Established creators with large audiences and proven systems.' },
] as const;

const ALL_CREATORS: CreatorProfile[] = [
  {
    id: 'maya',
    ...
    name: 'Maya',
    emoji: '🐼',
    avatar: CREATOR_MEDIA.maya.avatar || '',
    banner: CREATOR_MEDIA.maya.banner || '',
    followers: 1774,
    followersStr: '1.8K+',
    ...
    media: CREATOR_MEDIA.maya.media,
  ...
  },
  {
    ...
    name: 'KP',
    emoji: '📡',
    avatar: CREATOR_MEDIA.kp.avatar || '',
    banner: CREATOR_MEDIA.kp.banner || '',
    followers: 70600,
    followersStr: '70.6K',
  ...
  },
  {
    ...
    emoji: '🇵🇱',
    avatar: CREATOR_MEDIA.gerrit.avatar || '',
    banner: CREATOR_MEDIA.gerrit.banner || '',
    followers: 1114,
    followersStr: '1.1K',
    ...
    media: CREATOR_MEDIA.gerrit.media,
  ...
  },
  {
    ...
    name: 'Lynn Zeng',
    emoji: '🇲🇾',
    avatar: CREATOR_MEDIA.lynnzeng.avatar || '',
    banner: CREATOR_MEDIA.lynnzeng.banner || '',
    followers: 6568,
    followersStr: '6.6K',
    ...
    media: CREATOR_MEDIA.lynnzeng.media,
    category: 'netlify-shippers',
  ...
  },
  {
    ...
    name: 'Jai Bhagat',
    emoji: '☕',
    avatar: CREATOR_MEDIA.jaibhagat.avatar || '',
    banner: CREATOR_MEDIA.jaibhagat.banner || '',
    followers: 901,
    followersStr: '901',
    ...
    media: CREATOR_MEDIA.jaibhagat.media,
    category: 'netlify-shippers',
  ...
  },
  {
    ...
    emoji: '🇺🇸',
    avatar: CREATOR_MEDIA.nullai.avatar || '',
    banner: CREATOR_MEDIA.nullai.banner || '',
    followers: 116,
    followersStr: '116',
    ...
    media: CREATOR_MEDIA.nullai.media,
    category: 'netlify-shippers',
...

  {
    ...
    name: 'Maddie D. Reese',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.maddiedreese.avatar || '',
    banner: CREATOR_MEDIA.maddiedreese.banner || '',
    followers: 5006,
    followersStr: '5.0K+',
    ...
    media: CREATOR_MEDIA.maddiedreese.media,
    category: 'netlify-shippers',
...

  {
    ...
    name: 'Clark Wimberly',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.clarklab.avatar || '',
    banner: CREATOR_MEDIA.clarklab.banner || '',
    followers: 3718,
    followersStr: '3.7K+',
    ...
    media: CREATOR_MEDIA.clarklab.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    emoji: '🚀',
    avatar: CREATOR_MEDIA.rasaljaya.avatar || '',
    banner: CREATOR_MEDIA.rasaljaya.banner || '',
    followers: 500,
    followersStr: '500+',
    ...
    media: CREATOR_MEDIA.rasaljaya.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    name: 'Ayush 🙏',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.ayushtweetshere.avatar || '',
    banner: CREATOR_MEDIA.ayushtweetshere.banner || '',
    followers: 12100,
    followersStr: '12.1K',
    ...
    media: CREATOR_MEDIA.ayushtweetshere.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    emoji: '🚀',
    avatar: CREATOR_MEDIA.phanindra_ai.avatar || '',
    banner: CREATOR_MEDIA.phanindra_ai.banner || '',
    followers: 1966,
    followersStr: '2.0K+',
    ...
    media: CREATOR_MEDIA.phanindra_ai.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    media: CREATOR_MEDIA.ash_wesley_.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    name: 'Conor Martin',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.conormartin_.avatar || '',
    ...
    media: CREATOR_MEDIA.conormartin_.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    name: 'Carol Monroe',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.monroe_carol.avatar || '',
    ...
    media: CREATOR_MEDIA.monroe_carol.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    name: 'Nicolas Grenié',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.picsoung.avatar || '',
    banner: CREATOR_MEDIA.picsoung.banner || '',
    followers: 4100,
    followersStr: '4.1K+',
    ...
    media: CREATOR_MEDIA.picsoung.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    emoji: '🚀',
    avatar: CREATOR_MEDIA.nkgoutham.avatar || '',
    banner: CREATOR_MEDIA.nkgoutham.banner || '',
    followers: 1300,
    followersStr: '1.3K+',
    ...
    media: CREATOR_MEDIA.nkgoutham.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    name: 'Mark Bowley',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.markbowley.avatar || '',
    ...
    media: CREATOR_MEDIA.markbowley.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    emoji: '🚀',
    avatar: CREATOR_MEDIA.hacksultan.avatar || '',
    banner: CREATOR_MEDIA.hacksultan.banner || '',
    followers: 293200,
    followersStr: '293K+',
    ...
    media: CREATOR_MEDIA.hacksultan.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    name: 'Dhruval',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.dhruvalgolakiya.avatar || '',
    banner: CREATOR_MEDIA.dhruvalgolakiya.banner || '',
    followers: 5766,
    followersStr: '5.8K+',
    ...
    media: CREATOR_MEDIA.dhruvalgolakiya.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
...

  {
    ...
    name: 'Vamshi',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.idohodl.avatar || '',
    banner: CREATOR_MEDIA.idohodl.banner || '',
    followers: 1703,
    followersStr: '1.7K+',
    ...
    media: CREATOR_MEDIA.idohodl.media,
    category: 'netlify-shippers',
    theme: { primary: '#22d3ee', secondary: '#8b5cf6', accent: '#ec4899' },
    plays: [
      {
    ...
    name: 'Pieter Levels',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.levelsio.avatar || '',
    banner: CREATOR_MEDIA.levelsio.banner || '',
    followers: 910500,
    followersStr: '911K',
    ...
    media: CREATOR_MEDIA.levelsio.media,
    category: 'big-players',
    ...
    name: 'Tony Dinh',
    emoji: '🛠️',
    avatar: CREATOR_MEDIA.tdinh_me.avatar || '',
    banner: CREATOR_MEDIA.tdinh_me.banner || '',
    followers: 193500,
    followersStr: '194K',
    ...
    media: CREATOR_MEDIA.tdinh_me.media,
    category: 'indie-hackers',
    ...
    name: 'Danny Postma',
    emoji: '🤖',
    avatar: CREATOR_MEDIA.dannypostma.avatar || '',
    banner: CREATOR_MEDIA.dannypostma.banner || '',
    followers: 176200,
    followersStr: '176K',
    bio: 'Laying low',
    products: [],
    ...
    media: CREATOR_MEDIA.dannypostma.media,
    category: 'indie-hackers',
    ...
    name: 'Arvid Kahl',
    emoji: '📚',
    avatar: CREATOR_MEDIA.arvidkahl.avatar || '',
    banner: CREATOR_MEDIA.arvidkahl.banner || '',
    followers: 202400,
    followersStr: '202K',
    ...
    media: CREATOR_MEDIA.arvidkahl.media,
    category: 'indie-hackers',
    ...
    name: 'Jon Yongfook',
    emoji: '🐻',
    avatar: CREATOR_MEDIA.yongfook.avatar || '',
    banner: CREATOR_MEDIA.yongfook.banner || '',
    followers: 163900,
    followersStr: '164K',
    ...
    media: CREATOR_MEDIA.yongfook.media,
    category: 'indie-hackers',
    ...
    name: 'Hiten Shah',
    emoji: '💼',
    avatar: CREATOR_MEDIA.hnshah.avatar || '',
    banner: CREATOR_MEDIA.hnshah.banner || '',
    followers: 321600,
    followersStr: '322K',
    ...
    media: CREATOR_MEDIA.hnshah.media,
    category: 'big-players',
    theme: { primary: "#1DA1F2", secondary: "#FFFFFF", accent: "#00C4B4" },
    plays: [
      {
    ...
    name: 'Damon Chen',
    emoji: '💜',
    avatar: CREATOR_MEDIA.damengchen.avatar || '',
    banner: CREATOR_MEDIA.damengchen.banner || '',
    followers: 92900,
    followersStr: '93K',
    ...
    media: CREATOR_MEDIA.damengchen.media,
    category: 'indie-hackers',
    ...
    name: 'Flavio Copes',
    emoji: '📘',
    avatar: CREATOR_MEDIA.flaviocopes.avatar || '',
    banner: CREATOR_MEDIA.flaviocopes.banner || '',
    followers: 63700,
    followersStr: '64K',
    ...
    media: CREATOR_MEDIA.flaviocopes.media,
    category: 'indie-hackers',
    ...
    name: 'Pat Walls',
    emoji: '🚀',
    avatar: CREATOR_MEDIA.thepatwalls.avatar || '',
    banner: CREATOR_MEDIA.thepatwalls.banner || '',
    followers: 141100,
    followersStr: '141K',
    ...
    media: CREATOR_MEDIA.thepatwalls.media,
    category: 'indie-hackers',
    ...
    emoji: '🌐',
    avatar: CREATOR_MEDIA.biilmann.avatar || '',
    banner: CREATOR_MEDIA.biilmann.banner || '',
    followers: 12800,
    followersStr: '12.8K',
    ...
    media: CREATOR_MEDIA.biilmann.media,
    category: 'netlify-shippers',
    ...
    name: 'Nous Research',
    emoji: '🧠',
    avatar: CREATOR_MEDIA.nousresearch.avatar || '',
    banner: CREATOR_MEDIA.nousresearch.banner || '',
    followers: 229300,
    followersStr: '229K',
    ...
    media: CREATOR_MEDIA.nousresearch.media,
    category: 'big-players',
    ...
    name: 'Teknium',
    emoji: '🪽',
    avatar: CREATOR_MEDIA.teknium.avatar || '',
    banner: CREATOR_MEDIA.teknium.banner || '',
    followers: 105336,
    followersStr: '105K',
    ...
    media: CREATOR_MEDIA.teknium.media,
    category: 'big-players',
    ...
    name: 'Demis Hassabis',
    emoji: '🏆',
    avatar: CREATOR_MEDIA.demishassabis.avatar || '',
    banner: CREATOR_MEDIA.demishassabis.banner || '',
    followers: 1300000,
    followersStr: '1.3M',
    ...
    media: CREATOR_MEDIA.demishassabis.media,
    category: 'big-players',
    ...
    emoji: '🤖',
    avatar: CREATOR_MEDIA.karpathy.avatar || '',
    banner: CREATOR_MEDIA.karpathy.banner || '',
    followers: 3200000,
    followersStr: '3.2M',
    ...
    media: CREATOR_MEDIA.karpathy.media,
    category: 'big-players',
    ...
    name: 'Stability AI',
    emoji: '🎨',
    avatar: CREATOR_MEDIA.stabilityai.avatar || '',
    banner: CREATOR_MEDIA.stabilityai.banner || '',
    followers: 258100,
    followersStr: '258K',
    ...
    media: CREATOR_MEDIA.stabilityai.media,
    category: 'big-players',
...
export function getActiveCreators<T extends { id: string }>(creatorsList: T[]): T[] {
  // All creators are now released - time gating removed
  return creatorsList;
}

export const CREATORS = getActiveCreators(ALL_CREATORS);
