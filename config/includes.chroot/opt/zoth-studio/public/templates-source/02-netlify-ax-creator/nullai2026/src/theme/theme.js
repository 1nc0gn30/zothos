...
export const createAppTheme = (mode = 'dark') =>
  createTheme({
    palette: {
      mode,
      background: {
        default: mode === 'dark' ? '#05070d' : '#f6f8fc',
        ...
        styleOverrides: {
          body: {
            ...
            backgroundImage:
              mode === 'dark'
                ? `
                  radial-gradient(circle at 20% 15%, rgba(0,213,255,0.14), transparent 32%),
                  radial-gradient(circle at 80% 10%, rgba(50,255,133,0.12), transparent 30%),
                  linear-gradient(180deg, #05070d 0%, #070a12 65%)
                `
                : `
                  radial-gradient(circle at 24% 12%, rgba(0,213,255,0.16), transparent 34%),
                  radial-gradient(circle at 82% 8%, rgba(50,255,133,0.12), transparent 32%),
