        ...
        {status === 'unlocked' && (
          <div className="rounded-2xl border border-brand-900/60 bg-zinc-900/50 p-10">
            ...
            <div className="space-y-4">
              <a
                href="/assets/creatorkit-deploy-checklist.pdf"
                download
                className="flex items-center justify-between p-4 rounded-xl border border-zinc-800 hover:border-brand-500 transition"
              >
                <span className="font-medium">Deploy Checklist (PDF)</span>
                <Download size={18} className="text-zinc-400" />
              </a>
              <a
                href="/assets/creatorkit-env-template.txt"
                download
                className="flex items-center justify-between p-4 rounded-xl border border-zinc-800 hover:border-brand-500 transition"
              >
              ...
              <a
                href="/assets/creatorkit-stripe-setup-guide.md"
                download
                className="flex items-center justify-between p-4 rounded-xl border border-zinc-800 hover:border-brand-500 transition"
              >
                <span className="font-medium">Stripe Setup Guide (Markdown)</span>
                <Download size={18} className="text-zinc-400" />
              </a>
            </div>
          </div>
