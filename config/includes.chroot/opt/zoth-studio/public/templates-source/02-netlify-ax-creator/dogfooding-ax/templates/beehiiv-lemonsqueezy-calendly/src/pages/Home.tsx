...
import { Check, Mail, CreditCard, Calendar, Download, Zap } from 'lucide-react';
        ...
        <section className="py-20 md:py-28 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-zinc-400 mb-10">
              Newsletter, payments, and booking — beehiiv + LemonSqueezy + Calendly, wired up and ready to deploy on Netlify.
            </p>
        ...
        <section id="toolkit" className="py-20 px-6 bg-zinc-900">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              ...
              <p className="text-zinc-400">A complete starter kit for no-code creators and global indie makers.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              <Feature icon={Mail} title="Newsletter engine" desc="Capture subscribers with beehiiv — auto-subscribed from your site." />
              <Feature icon={CreditCard} title="LemonSqueezy payments" desc="Accept one-time payments with automatic VAT/tax handling for global sales." />
              <Feature icon={Calendar} title="Calendly booking" desc="Let visitors book calls through Calendly." />
              <Feature icon={Download} title="Digital delivery" desc="Gated toolkit page unlocked after purchase." />
              <Feature icon={Zap} title="Netlify-native" desc="Deploy in minutes with serverless functions and redirects." />
              <Feature icon={Check} title="Open source" desc="Fork it, customize it, own your stack." />
            </div>
          </div>
        </section>
