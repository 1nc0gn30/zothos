    ...
    >
      <Paper
        sx={{
          ...
          minWidth: 320,
          borderRadius: '20px',
          background: `linear-gradient(135deg, ${alpha('#1e293b', 0.95)}, ${alpha('#0f172a', 0.98)})`,
          backdropFilter: 'blur(20px)',
          border: `1px solid ${alpha(theme.palette.primary.main, 0.3)}`,
          boxShadow: `0 30px 60px rgba(0,0,0,0.8), inset 0 0 20px ${alpha(theme.palette.primary.main, 0.1)}`,
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        ...
        <Stack spacing={2.5}>
          ...
          <Stack spacing={1.5}>
            <Box>
              ...
              <Typography variant="body2" sx={{ fontFamily: 'monospace', bgcolor: alpha('#000', 0.3), p: 1, borderRadius: 1 }}>
            ...
            <Box>
              ...
              <Typography variant="caption" sx={{ display: 'block', opacity: 0.7, lineHeight: 1.5 }}>
                Local-first intelligence kernel. <br />
                Multi-vector OSINT indexing enabled. <br />
                Neural processing: <span style={{ color: theme.palette.success.main }}>ACTIVE</span>
              </Typography>
            </Box>
          </Stack>
      ...
      <Fade in={!hidden}>
        ...
        >
          <Stack direction="row" spacing={1} alignItems="flex-end" sx={{ px: 1 }}>
            ...
            <ActionIcon active={path.startsWith('/playground')} onClick={() => navigate('/playground')} label="Playground" mouseX={mouseX}>
              <ScienceIcon />
            </ActionIcon>

            <ActionIcon active={path.startsWith('/osint')} onClick={() => navigate('/osint')} label="OSINT" mouseX={mouseX}>
              <TravelExploreIcon />
            </ActionIcon>
            ...
            <ActionIcon active={path.startsWith('/privacy')} onClick={() => navigate('/privacy-policy')} label="Security" mouseX={mouseX}>
              <PolicyIcon />
            </ActionIcon>
