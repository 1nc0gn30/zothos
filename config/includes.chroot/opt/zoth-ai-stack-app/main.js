...
const AI_TOOLS_DATABASE = [
  ...
  { id: 'litellm', name: 'LiteLLM Proxy', domain: 'Local Inference', desc: 'Universal OpenAI-Compatible Proxy in Front of 100+ LLMs', cmd: 'litellm', pkg: 'pip3 install --user litellm', type: 'pip' },

  // Assistants & Drivers
  { id: 'aider', name: 'Aider AI', domain: 'Assistants & Drivers', desc: 'Git-Aware Terminal Pair Programmer for LLM Refactoring', cmd: 'aider', pkg: 'pip3 install --user aider-chat', type: 'pip' },
  { id: 'goose', name: 'Block Goose', domain: 'Assistants & Drivers', desc: 'Block Open-Source Autonomous Developer Agent', cmd: 'goose', pkg: 'curl -fsSL https://block.github.io/goose/install.sh | bash', type: '1liner' },
  { id: 'open-interpreter', name: 'Open Interpreter', domain: 'Assistants & Drivers', desc: 'Natural Language Code Execution Engine for Linux', cmd: 'interpreter', pkg: 'pip3 install --user open-interpreter', type: 'pip' },
  { id: 'browser-use', name: 'Browser Use', domain: 'Assistants & Drivers', desc: 'Web Browser Driving & Automation Agent Core', cmd: 'browser-use', pkg: 'pip3 install --user browser-use', type: 'pip' },
  ...
  { id: 'fastmcp', name: 'FastMCP Toolkit', domain: 'MCP & Tooling', desc: 'Python MCP Server Toolkit for Rapid Tool Development', cmd: 'fastmcp', pkg: 'pip3 install --user fastmcp', type: 'pip' },
  ...
  { id: 'garak', name: 'Garak Scanner', domain: 'AI Red Teaming', desc: 'LLM Vulnerability, Jailbreak & Hallucination Scanner', cmd: 'garak', pkg: 'pip3 install --user garak', type: 'pip' },
  { id: 'pyrit', name: 'PyRIT Red Team', domain: 'AI Red Teaming', desc: 'Microsoft Python Risk Identification Toolkit for AI', cmd: 'pyrit', pkg: 'pip3 install --user pyrit', type: 'pip' },
  { id: 'promptfoo', name: 'Promptfoo Eval', domain: 'AI Red Teaming', desc: 'LLM Prompt, Output & Security Evaluation Suite', cmd: 'promptfoo', pkg: 'npm install -g --prefix ~/.local promptfoo', type: 'npm' },
  { id: 'inspect', name: 'Inspect AI', domain: 'AI Red Teaming', desc: 'UK AISI Framework for Large Language Model Evaluation', cmd: 'inspect', pkg: 'pip3 install --user inspect-ai', type: 'pip' },

  // Generative Interfaces
  { id: 'open-webui', name: 'Open WebUI', domain: 'Interfaces', desc: 'Local ChatGPT-Style Rich Web Interface on Port 8080', cmd: 'open-webui', pkg: 'pip3 install --user open-webui', type: 'pip' },
  { id: 'comfyui', name: 'ComfyUI Studio', domain: 'Interfaces', desc: 'Modular Node-Based Visual & Diffusion Generation Engine', cmd: 'comfyui', pkg: 'pip3 install --user comfyui', type: 'pip' },
